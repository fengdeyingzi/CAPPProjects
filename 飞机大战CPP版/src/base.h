...
#define _RUN_MODE "gcc"
    ...
    typedef uintptr_t uint32; // 无符�?32bit整型
    typedef uintptr_t int32;               // 有符�?32bit整型
    typedef intptr_t intptr;              // 用于保存指针地址的整�?
...
#define FALSE 0
    ...
    */
    ...
    extern int32 app_wstrlen(char *s);
    #define wstrlen(s) app_wstrlen(s)
