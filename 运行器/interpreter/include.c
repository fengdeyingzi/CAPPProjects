...
// #endif
    ...
    IncludeRegister(pc,"base.h", &mrc_base_SetupFunc, &mrc_base_Functions[0], mrc_base_Defs);
    IncludeRegister(pc,"sound.h", &Sound_SetupFunc, &Sound_Functions[0], NULL);
	IncludeRegister(pc,"graphics.h", &bitmapSetupFunc, &bitmapFunctions[0],bitmap_Defs);
  	IncludeRegister(pc,"android.h", &androidSetupFunc, &androidFunctions[0],android_Defs);
	IncludeRegister(pc,"exb.h", &exbSetupFunc,         &exbFunctions[0],    exb_Defs);
	// 	IncludeRegister(pc,"net.h", &netSetupFunc,         &netFunctions[0],    net_Defs);
	// 	IncludeRegister(pc,"ex_game.h", &Ex_GameSetupFunc,         &Ex_GameFunctions[0],    game_Defs);
	IncludeRegister(pc,"ex_math.h", &Ex_MathSetupFunc, &Ex_MathFunctions[0], NULL);
}
