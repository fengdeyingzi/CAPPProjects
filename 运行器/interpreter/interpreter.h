...
# endif
    ...
    //xldebug const char *VersionString;
    char *VersionString;
...
//ex_math.h
extern struct LibraryFunction Ex_MathFunctions[];
...
//android
extern const char android_Defs[];
extern struct LibraryFunction androidFunctions[] ;
void androidSetupFunc(Picoc *pc);

//exb.h
extern const char exb_Defs[];
extern struct LibraryFunction exbFunctions[];
void exbSetupFunc(Picoc *pc);

extern const char net_Defs[];
extern struct LibraryFunction netFunctions[];
void netSetupFunc(Picoc *pc);


//game.h
extern const char game_Defs[];
extern struct LibraryFunction Ex_GameFunctions[];
void Ex_GameSetupFunc(Picoc *pc);
