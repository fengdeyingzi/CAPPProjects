...
static long BigEndian;
static long LittleEndian;
static long TRUEValue = 1;
static long ZeroValue = 0;
...
void LibraryInit(Picoc *pc)
{
    ...
    VariableDefinePlatformVar(pc,NULL, "SCRW", &pc->UnsignedShortType, (union AnyValue *)&SCRW, FALSE);
    VariableDefinePlatformVar(pc,NULL, "SCRH", &pc->UnsignedShortType, (union AnyValue *)&SCRH, FALSE);
}
